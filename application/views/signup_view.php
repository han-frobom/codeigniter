...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url(); ?>index.php/home">CI Registers</a>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well">
			...
			echo form_open("signup/signup_user", $attributes);?>
			...
			<div class="form-group">
				...
				<input class="form-control" name="address" placeholder="address Name" type="text" value="<?php echo set_value('address'); ?>" />
